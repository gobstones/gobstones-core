...
//         UnmatchingPositionsBy: 'Las posiciones determinan entradas diferentes en ${operation} de ${context}.',
//         AtEndOfInputBy: 'La operación ${operation} de ${context} no funciona al final de la entrada.',
//         AtEndOfDocumentBy: 'La operación ${operation} de ${context} no funciona al final de un documento.'
//     },
//     string: {
