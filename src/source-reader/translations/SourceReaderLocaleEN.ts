...
//         UnmatchingPositionsBy: 'Positions determine different source inputs at `${operation}` of `${context}`.',
//         AtEndOfInputBy: 'Operation `${operation}` of `${context}` cannot work at the end of the source input.',
//         AtEndOfDocumentBy: 'Operation `${operation}` of `${context}` cannot work at the end of a document.'
//     },
//     string: {
