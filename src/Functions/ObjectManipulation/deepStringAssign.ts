 ...
 */
export const deepStringAssign = <T extends object>(target: T, ...sources: Subset<T>[]): T => {
    ...
    for (const source of sources) {
        for (const k of Object.keys(source)) {
            ...
            if (typeof source[key] === 'object') {
                ...
                cloneTarget[key] = deepStringAssign<typeof tmp>(tmp, source[key] as object) as unknown as T[keyof T];
            }
