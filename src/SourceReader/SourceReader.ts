 ...
 * @private
 */
export interface SourceReaderInterface {
    // ===============================================
     ...
     */
    readonly documentsNames: string[];
     ...
     * @group API: Access
     */
    getUnknownPosition(): SourcePosition;
     ...
     */
    skip(howMuch?: number | string, silently?: boolean): void;
     ...
     * @group API: Modification
     */
    takeWhile(contCondition: (ch: string) => boolean, silently?: boolean): string;
     ...
     * @group API: Modification
     */
    beginRegion(regionId: string): void;
...
// -----------------------------------------------
// #endregion } interface SourceReader
// ===============================================
 ...
 * @group API: Main
 */
export class SourceReader implements SourceReaderInterface {
    // ===============================================
